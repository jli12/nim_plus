...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.threshold_lbl.resize(200, 20)
		# Channel 1
		...
		self.bool_lbl.move(int(WIN_X/2)+100, 15)
		...
		self.bool_box_1.move(int(WIN_X/2)+160, 90)
		...
		self.bool_box_2.move(int(WIN_X/2)+160, 130)
		...
		self.bool_box_3.move(int(WIN_X/2)+160, 170)
		...
		self.bool_box_4.move(int(WIN_X/2)+160, 210)
		...
		self.cnt_lbl_1.move(int(WIN_X/2-420), int(2*WIN_Y/3)-130)

		self.cnt_disp_1 = QLabel("None", self)
		self.cnt_disp_1.move(int(WIN_X/2-360), int(2*WIN_Y/3)-130)
		# Counter 2
		self.cnt_lbl_2 = QLabel('Counter 2:', self)
		self.cnt_lbl_2.move(int(WIN_X/2-210), int(2*WIN_Y/3)-130)

		self.cnt_disp_2 = QLabel("None", self)
		self.cnt_disp_2.move(int(WIN_X/2-150), int(2*WIN_Y/3)-130)
		# Counter 3
		self.cnt_lbl_3 = QLabel('Counter 3:', self)
		self.cnt_lbl_3.move(int(WIN_X/2+40), int(2*WIN_Y/3)-130)

		self.cnt_disp_3 = QLabel("None", self)
		self.cnt_disp_3.move(int(WIN_X/2+100), int(2*WIN_Y/3)-130)
		# Counter 4
		self.cnt_lbl_4 = QLabel('Counter 4:', self)
		self.cnt_lbl_4.move(int(WIN_X/2+240), int(2*WIN_Y/3)-130)

		self.cnt_disp_4 = QLabel("None", self)
		self.cnt_disp_4.move(int(WIN_X/2+300), int(2*WIN_Y/3)-130)
	...
	def update_counter(self, vals):
		if not self.paused:
			...
			counts = vals[0]
			# Take into account "subruns" from pauses
			self.rates = [count_i/(self.current_time - self.start_time + self.past_time) for count_i in counts]
			# rates = vals[1]
			# time = vals[2]
	...
	def pause_count(self):
		if self.paused: # unpause
			...
			# Save current time and add to past time
